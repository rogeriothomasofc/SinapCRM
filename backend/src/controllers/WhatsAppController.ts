...
import SyncContactsFromBaileysService from "../services/WbotServices/SyncContactsFromBaileysService";
...
export const syncContacts = async (
  ...
  const result = await SyncContactsFromBaileysService({ whatsappId: +whatsappId });
