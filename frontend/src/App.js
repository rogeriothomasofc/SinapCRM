    ...
    const theme = useMemo(() => createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? primaryColor : "#FFFFFF" },
                ...
                barraSuperior: mode === "light" ? `linear-gradient(to right, ${primaryColor}, ${primaryColor}, ${primaryColor})` : "#666",
        ...
        locale
    ), [mode, locale, primaryColor, secondaryColor]); // eslint-disable-line react-hooks/exhaustive-deps
